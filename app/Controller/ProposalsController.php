<?php
	class ProposalsController extends AppController {
		...
		public function view($id = null) {
			...
			$speakers= $this->Proposal->Speaker->find('all',array('conditions' => array('Speaker.proposal_id' => $id, 'Speaker.user_id' =>$user_id)));
			$lenSpeaker= count($speakers);
			if($lenSpeaker>=1){
				...
				return $this->redirect(array('action' => 'viewnospeaker', $id));
			}
		}
		
		//Pueden verlo administradores y usuarios
		public function viewnospeaker($id = null) {
